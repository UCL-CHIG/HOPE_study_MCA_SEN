...
2012/13 only, then collected as part of the the NPD School Census) | |
| Get Information about Schools (opensource data linked to ECHILD) | GIAS | Department for Education | Pupil level information for studens in state-maintained educational settings in England. Linked to ECHILD using each school’s unique reference number (URN) | |
## Data access
